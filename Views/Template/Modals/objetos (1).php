...
<main class="app-content">
  <div class="app-title">
    <div>
      ...
      <h1><i class="fa fa-desktop"></i> <?= $data['page_title'];  ?>
              ...
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <?php } ?> 
                    <thead>
                      <tr >
                        <th class="sorting_asc" tabindex="0" aria-controls="sampleTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Secuencial: activar para ordenar de manera descendente" style="width: 5px;">Id</th>
