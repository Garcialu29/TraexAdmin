        ...
        <tbody>
            <tr>
                ...
                <td class="text-center wd33">
                    ...
                    <h3><strong>Lista de Tipos de Envios</strong></h3>
                </td>
                <td class="wd33">
    ...
    <table class="tbl-detalle"> 
        <thead>
            <tr>
                ...
                <th class="text-center"style="width: 380px;">Descripción</th>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="text-center"><?= $datos['monto'] ?></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
