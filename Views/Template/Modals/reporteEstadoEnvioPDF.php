...
<head>
    ...
    <style>
        ...
        .table-container {
            ...
            margin: 50px auto; /* Centrar el contenedor y añadir margen superior e inferior */
            width: 100%; /* Asegurar que el contenedor ocupa el ancho completo */
        }
        ...
        <tbody>
            <tr>
                ...
                <td class="text-center wd33">
                    ...
                    <h3><strong>Lista de Estados de Envios</strong></h3>
                </td>
                <td class="wd33">
