        ...
        <table class="tbl-detalle">
            <thead>
                <tr>
                    ...
                    <th class="text-center" style="width: 120px;">Rol</th>
                    <th class="text-center" style="width: 320px;">Descripción</th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center"><?= $datos['Descripcion_Rol'] ?></td>
                        <td class="text-center"><?php if ($datos['estado_rol'] == 1) {
                                                        echo "Activo";
                                                    } else {
                                                        echo "Inactivo";
                                                    } ?>
