		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>Si estás recibiendo este correo electrónico, es porque has solicitado restablecer la contraseña para el usuario: <strong><?= $data['email']; ?></strong></p>
					<p>Haz clic en el enlace que se encuentra a continuación para ir a nuestra página de restablecimiento de contraseña: </p>
					...
					<p>Si no solicitaste restablecer tu contraseña, por favor ignora este correo electrónico.</p>
				</td>
			</tr>
		</tbody>
	</table>
