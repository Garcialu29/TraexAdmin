<?php   
    headerAdmin($data); 
    getModal('modalTipoEnvio',$data);
?>
    <div id="contentAjax"></div> 
    <main class="app-content">
      <div class="app-title">
        <div>
        <h1><i class="fas fa-plane"></i> <?= $data['page_title'] ?>
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?= base_url(); ?>/tipoEnvios"><?= $data['page_title'] ?></a></li>
        </ul>
      </div>
              ...
              <div class="tile">
                <div class="tile-body">
                  <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="tableTipoEnvio">
