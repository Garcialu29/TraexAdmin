...
<body class="  pace-done">
            ...
            <form class="login-form" id="formCambiarPass" name="formCambiarPass" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="invalid-feedback">
                        La contraseña debe contener 1 carácter especial, 1 minúscula y al menos 8 caractéres
                    </div>
    ...
    <script>
        const base_url = "<?= base_url(); ?>/perfil "; // nos ayuda a usar la funcion base url donde nos devuelve la ruta raiz del proyecto y por lo tanto se puede usar en archivo js de login
    </script>
