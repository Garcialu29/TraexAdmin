...
if($result){
    ...
    if($error==1){
        ...
        chmod("C:\Users\garci\Documents\proyect github\TraexAdmin\BRM-master\backup", 0777);
        $sql.='SET FOREIGN_KEY_CHECKS=1;';
        $handle=fopen("C:\Users\garci\Documents\proyect github\TraexAdmin\BRM-master\backup".$DataBASE,'w+');
