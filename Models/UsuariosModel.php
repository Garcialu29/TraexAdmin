<?php 
	...
	class UsuariosModel extends Mysql
	{
        ...
        public function insertUsuario(string $rolusuario, string $nombre, string $password, int $telefono,
         string $direccion, string $email, int $status, string $fechavencimiento ){
            ...
            if(empty($request)){
                $query_insert = "INSERT INTO tbl_usuarios (
       ...
       // $this->strfechavencimiento =  $strFechavencimiento;
        ...
        $sql = "SELECT * FROM tbl_usuarios WHERE (Correo_Electronico = '{$this->strEmail}' AND id_usuario != $this->intIdUsuario)
    ...
    public function updateIntentos(int $id_Usuario, string $intento){
        ...
        $sql = "UPDATE tbl_usuarios  SET intentos_acceso = ? WHERE id_usuario = $this->intIdusuario";
    ...
    public function deleteUsuario(int $intIdpersona)
    {
		...
		$sql = "SELECT * FROM tbl_rol where estado_rol =1";
