<?php 
	...
	class Preguntas_seguridadModel extends Mysql
	{
		...
		public function selecParametro(int $idparametro)
		{
			...
			$sql = "SELECT * FROM tbl_preguntas WHERE Id_Pregunta = $this->intIdparametro";
		...
		public function InsertParametro(string $Nombre, string $fecha){
            ...
            $this->strfecha = $fecha;
				...
				$query_insert  = "INSERT INTO tbl_preguntas(Pregunta,Fecha_Creacion) VALUES(?,?)";
		...
		public function updateParametro(int $idparametro, string $nombre){
			...
			$this->strParametro = $nombre;
				...
				$sql = "UPDATE tbl_preguntas SET Pregunta = ? WHERE Id_Pregunta = $this->intIdParametro ";
		...
		public function deleteParametro(int $idparametro)
		{
			$this->IntParametro = $idparametro;
				...
				$sql = "DELETE  FROM  tbl_preguntas WHERE Id_Pregunta = $this->IntParametro ";
				$arrData = array(0);
